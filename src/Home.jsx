...
function KeyHome() {
  return (
    <div className="master">
      ...
      <img src={diapo8} alt='diapo7' style={{ width: '100%', height: 'auto' }} className="responsive-image" />
      <img src={diapo9} alt='diapo7' style={{ width: '100%', height: 'auto' }} className="responsive-image" />
    </div>
  );
}
